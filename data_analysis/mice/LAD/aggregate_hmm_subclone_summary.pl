...
open (FI,"/workspace/projects/lesion_segregation/mice/data/list_of_samples.txt");
#open (IN,"$fi")||die;
open (OUT,">../results/HMM/Summary_ploidy.tsv");

while (<FI>){
    chomp;
    my $na=$_;
    my $BW="../results/HMM/HMM_subclone/$_.hmm.BW";
    my $AS="../results/HMM/HMM_subclone/$_.hmm.CloneAS";
    my $VAF="../results/HMM/HMM_subclone/$_.hmm.Clonesize";
