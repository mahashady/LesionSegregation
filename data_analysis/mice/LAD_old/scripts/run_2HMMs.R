...
output_dir <- "../results/HMM/output_HMM/"
if (!dir.exists(output_dir)) dir.create(output_dir, recursive = TRUE)

fnf1 <- paste(output_dir, fn,".summary",sep = "")
fnf2 <- paste(output_dir, fn,".ASHMM",sep = "")
fnf3 <- paste(output_dir, fn,".PloidyHMM",sep = "")
fnf4 <- paste(output_dir, fn,".bwASEM",sep = "") ### bw$hmm$emissionProbs
fnf5 <- paste(output_dir, fn,".bwPlEM",sep = "") ### bwM$hmm$emissionProbs
